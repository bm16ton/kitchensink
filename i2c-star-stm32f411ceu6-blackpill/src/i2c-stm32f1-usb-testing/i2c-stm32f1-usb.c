...
static const struct usb_device_descriptor dev = {
	...
	.bcdUSB = 0x0200,
	.bDeviceClass = 0xEF,  //16ton was 0xff
	.bDeviceSubClass = 2,
	.bDeviceProtocol = 1,
	.bMaxPacketSize0 = 32,
	.idVendor = 0x0403,
...
const struct usb_interface_descriptor i2c_iface = {
	...
	.bAlternateSetting = 0,
	.bNumEndpoints = 1,
	.bInterfaceClass = 0xEf,   // was  0
	.bInterfaceSubClass = 2,   // was 0
	.bInterfaceProtocol = 1,   // was 0
	.iInterface = 0,
...
//	(void)wValue;
	...
	usbd_ep_setup(usbd_dev, 0x03, USB_ENDPOINT_ATTR_BULK, 64, usbuart_usb_out_cb);
	usbd_ep_setup(usbd_dev, 0x83, USB_ENDPOINT_ATTR_BULK, 64, usbuart_usb_in_cb);
...
//    cdcacm_set_modem_state(usbd_dev, UART_IF_NO, true, true);
