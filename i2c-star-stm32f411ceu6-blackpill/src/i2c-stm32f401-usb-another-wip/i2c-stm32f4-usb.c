...
//	(void)wValue;
	...
	usbd_ep_setup(usbd_dev, 0x83, USB_ENDPOINT_ATTR_BULK, 64, usbuart_usb_out_cb);
	usbd_ep_setup(usbd_dev, 0x03 | USB_REQ_TYPE_IN, 0x03, 64, usbuart_usb_in_cb);
	usbd_ep_setup(usbd_dev, 0x84 | USB_REQ_TYPE_IN, USB_ENDPOINT_ATTR_INTERRUPT, 16, NULL);
