...
static const struct usb_device_descriptor dev_desc3 = {
...
static const struct usb_endpoint_descriptor slcan_data_endp[] = {
	{
		.bLength = USB_DT_ENDPOINT_SIZE,
		.bDescriptorType = USB_DT_ENDPOINT,
		.bEndpointAddress = CDCACM_SLCAN_ENDPOINT, //1
...
static const struct usb_interface_descriptor slcan_data_iface = {
	.bLength = USB_DT_INTERFACE_SIZE,
	.bDescriptorType = USB_DT_INTERFACE,
	.bInterfaceNumber = SLCAN_IF_NO + 1, //0
	.bAlternateSetting = 0,
	.bNumEndpoints = 2,
...
static const struct usb_endpoint_descriptor uart3_comm_endp = {
	.bLength = USB_DT_ENDPOINT_SIZE,
	.bDescriptorType = USB_DT_ENDPOINT,
	.bEndpointAddress = (CDCACM3_UART_ENDPOINT + 1) | USB_REQ_TYPE_IN,
	.bmAttributes = USB_ENDPOINT_ATTR_INTERRUPT,
	.wMaxPacketSize = 16,
	.bInterval = 255,
};

static const struct usb_endpoint_descriptor uart3_data_endp[] = {
	{
		.bLength = USB_DT_ENDPOINT_SIZE,
		.bDescriptorType = USB_DT_ENDPOINT,
		.bEndpointAddress = CDCACM3_UART_ENDPOINT, //2
		.bmAttributes = USB_ENDPOINT_ATTR_BULK,
	...
	},
	{
		.bLength = USB_DT_ENDPOINT_SIZE,
		.bDescriptorType = USB_DT_ENDPOINT,
		.bEndpointAddress = CDCACM3_UART_ENDPOINT | USB_REQ_TYPE_IN,
		.bmAttributes = USB_ENDPOINT_ATTR_BULK,
		.wMaxPacketSize = CDCACM_PACKET_SIZE,
		.bInterval = 1,
	},
...
static const struct {
	...
	struct usb_cdc_acm_descriptor acm;
	struct usb_cdc_union_descriptor cdc_union;
} __attribute__((packed)) uart3_cdcacm_functional_descriptors = {
	.header =
		{
			.bFunctionLength = sizeof(struct usb_cdc_header_descriptor),
			.bDescriptorType = CS_INTERFACE,
...
static const struct usb_interface_descriptor uart3_comm_iface = {
	.bLength = USB_DT_INTERFACE_SIZE,
	.bDescriptorType = USB_DT_INTERFACE,
	...
	.endpoint = &uart3_comm_endp,

	.extra = &uart3_cdcacm_functional_descriptors,
	.extralen = sizeof(uart3_cdcacm_functional_descriptors),
};

static const struct usb_interface_descriptor uart3_data_iface = {
	.bLength = USB_DT_INTERFACE_SIZE,
	.bDescriptorType = USB_DT_INTERFACE,
	...
	.endpoint = uart3_data_endp,
};

static const struct usb_iface_assoc_descriptor uart3_assoc = {
	.bLength = USB_DT_INTERFACE_ASSOCIATION_SIZE,
	.bDescriptorType = USB_DT_INTERFACE_ASSOCIATION,
...
*/
const struct usb_dfu_descriptor dfu3_function = {
...
const struct usb_interface_descriptor dfu3_iface = {
	.bLength = USB_DT_INTERFACE_SIZE,
	.bDescriptorType = USB_DT_INTERFACE,
	...
	.extra = &dfu3_function,
	.extralen = sizeof(dfu3_function),
};

static const struct usb_iface_assoc_descriptor dfu3_assoc = {
	.bLength = USB_DT_INTERFACE_ASSOCIATION_SIZE,
	.bDescriptorType = USB_DT_INTERFACE_ASSOCIATION,
...
static const struct usb_interface ifaces3[] = {
	...
	{
		.num_altsetting = 1,
		.iface_assoc = &uart3_assoc,
		.altsetting = &uart3_comm_iface,
	},
	{
		.num_altsetting = 1,
		.altsetting = &uart3_data_iface,
	},
	{
		.num_altsetting = 1,
		.iface_assoc = &dfu3_assoc,
		.altsetting = &dfu3_iface,
	},
};
...
static const char *const usb_strings3[] = {
	"Black Magic Debug",
	BOARD_IDENT,
	"367E36723135",
